...
namespace PriSecFileStorageAPI.Controllers
{
    ...
    public class OwnerUploadFiles : ControllerBase
    {
        ...
        [HttpGet("GetOwnerFolderSize")]
        public String GetFolderSize(String FolderID) 
        {
            String FileStoragePath = "{Path to ETLS}";
            String ResultString = "";
            int Result = 0;
            int KeyBytesLength = 128;
            if (FolderID != null) 
            {
                FileStoragePath += FolderID;
                if (Directory.Exists(FileStoragePath) == true) 
                {
                    Result = GetDirectorySizeClass.GetDirectorySize(FileStoragePath);
                    Result -= KeyBytesLength;
        ...
        public String GetFileContentCount(String ClientPathID, String CipheredSignedDirectoryID, String SignedSignedRandomChallenge, String SignedUniqueFileName)
        {
            CryptographicSecureIDGenerator IDGenerator = new CryptographicSecureIDGenerator();
            VerifyDataClass verifyDataClass = new VerifyDataClass();
            DecodeDataClass decodeDataClass = new DecodeDataClass();
        ...
        public String GetFile(String ClientPathID, String CipheredSignedDirectoryID, String SignedSignedRandomChallenge, String SignedUniqueFileName, String FileContentCount)
        {
            CryptographicSecureIDGenerator IDGenerator = new CryptographicSecureIDGenerator();
            VerifyDataClass verifyDataClass = new VerifyDataClass();
            DecodeDataClass decodeDataClass = new DecodeDataClass();
        ...
        public String DeleteFile(String ClientPathID, String CipheredSignedDirectoryID, String SignedSignedRandomChallenge, String SignedUniqueFileName)
        {
            CryptographicSecureIDGenerator IDGenerator = new CryptographicSecureIDGenerator();
            VerifyDataClass verifyDataClass = new VerifyDataClass();
            DecodeDataClass decodeDataClass = new DecodeDataClass();
