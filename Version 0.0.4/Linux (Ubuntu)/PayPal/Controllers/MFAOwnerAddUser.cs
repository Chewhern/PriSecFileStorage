...
namespace PriSecFileStorageAPI.Controllers
{
    ...
    [ApiController]
    public class MFAOwnerAddUser : ControllerBase
    {
        ...
        [HttpGet("UploadPK")]
        public String OwnerUploadPK(String ClientPathID, String CipheredSignedDirectoryID, String SignedSignedRandomChallenge, String CipheredSignedED25519PK, String FirstMFADeviceID, String SecondMFADeviceID)
        {
        ...
        [HttpGet("RemovePK")]
        public String OwnerRemovePK(String ClientPathID, String CipheredSignedDirectoryID, String SignedSignedRandomChallenge, String CipheredSignedAnotherUserID, String FirstMFADeviceID, String SecondMFADeviceID)
        {
            CryptographicSecureIDGenerator IDGenerator = new CryptographicSecureIDGenerator();
            VerifyDataClass verifyDataClass = new VerifyDataClass();
            DecodeDataClass decodeDataClass = new DecodeDataClass();
